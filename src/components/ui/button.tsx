  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 transition-bounce px-8 py-3 text-base font-semibold",
        ...
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-lg hover:scale-105 transition-bounce",
        ghost: "text-muted-foreground hover:text-foreground hover:bg-muted transition-smooth",
        link: "text-primary underline-offset-4 hover:underline transition-smooth",
        secondary: "bg-muted text-muted-foreground hover:bg-muted/80 transition-smooth",
      },
      size: {
