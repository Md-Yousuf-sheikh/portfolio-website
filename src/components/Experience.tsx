...
const Experience = () => {
  ...
  const experiences = [
    {
      ...
      type: "Full-time",
      description:
        "Spearheaded the end-to-end development of multiple cutting-edge mobile applications using React Native and Expo, consistently delivering projects on time and exceeding client expectations.",
      achievements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Contributed to the development of MedLink, a comprehensive digital platform designed to connect healthcare professionals with recruiters.",
      achievements: [
  ...
  const shortInfoExp = [
    { label: "Years Experience", value: INFO?.YEARS_EXPERIENCE, icon: "📅" },
    { label: "Projects Completed", value: INFO?.PROJECTS_COMPLETED, icon: "🚀" },
    { label: "Apps Published", value: INFO?.APPS_PUBLISHED, icon: "📱" },
    { label: "Technologies", value: INFO?.TECHNOLOGIES_TOTAL, icon: "⚡" },
  ];
  ...
  return (
    <section
      id="experience"
      className="py-section bg-background-secondary relative overflow-hidden"
    >
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            A timeline of my professional growth and the impact I've made at
            various organizations throughout my career.
          </motion.p>
        </motion.div>
